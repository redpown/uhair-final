...
namespace Expression.Blend.DataStore.DataStore
{
    ...
    public class DataStore : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public DataStore()
        {
            try
            {
                System.Uri resourceUri = new System.Uri("/WpfApplication9;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
        ...
        public string Property2
        {
            get
            {
                return DataStoreGlobalStorage.Singleton.Property2;
            }

            set
            {
                DataStoreGlobalStorage.Singleton.Property2 = value;
            }
        }
    }
}
